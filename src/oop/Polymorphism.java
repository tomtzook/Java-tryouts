...
public class Polymorphism {
	...
	private static final int OBJECT_COUNT = (int)1e5;
	...
	public void testNormal(){
		Tester.println("Array : size - "+OBJECT_COUNT + " type - "+NormalClass.class.getSimpleName());
	...
	public void testNormal2(){
		Tester.println("Array 1: size - "+HALF_OBJECT_COUNT + " type - "+NormalClass.class.getSimpleName());
		Tester.println("Array 2: size - "+HALF_OBJECT_COUNT + " type - "+NormalClass2.class.getSimpleName());
	...
	public void testPoly(){
		Tester.println("Array : size - "+OBJECT_COUNT + " type - "+PolyBase.class.getSimpleName());
		Tester.println("Implementation 1: amount - " + HALF_OBJECT_COUNT + " type - " + Poly1.class.getSimpleName());
	...
	public void testPoly2(){
		Tester.println("Array : size - "+OBJECT_COUNT + " type - "+PolyBase.class.getSimpleName());
		Tester.println("Implementation 1: amount - " + HALF_OBJECT_COUNT + " type - " + Poly1.class.getSimpleName());
		Tester.println("Implementation 2: amount - " + HALF_OBJECT_COUNT + " type - " + Poly2.class.getSimpleName());
